...
def parse_args():
    ...
    parser.add_argument('--model', '-m',
                        ...
                        help='Model name: SimpleNet or XceptionBased.') #'XceptionBased'
    parser.add_argument('--train_details_json', '-j',
                        default='../output/fakes_dataset_SimpleNet_Adam.json', type=str,
                        help='Json containing loss and accuracy.') #'out/XceptionBased_Adam.json'
    #TODO: find to what to change the default here
